...
\input{time_offset_management}

\subsection{Contribution Management}
\input{contribution_management}
...
\input{crowd_simulated_dal}

\subsection{UGV Dataset Synchronization} 
\input{ugv_dataset_synchronization}
